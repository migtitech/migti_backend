...
exports.updateAdminAccessController = exports.updateAdmin = exports.loginSuperAdmin = exports.loginAdmin = exports.listAdmin = exports.getAdminByIdController = exports.deleteAdminController = exports.createAdmin = void 0;
...
var loginSuperAdmin = exports.loginSuperAdmin = /*#__PURE__*/function () {
  var _ref2 = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee2(req, res) {
    var _loginSuperAdminSchem, error, value, result;
    return _regenerator["default"].wrap(function (_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _loginSuperAdminSchem = _adminValidator.loginSuperAdminSchema.validate(req.body, {
            abortEarly: false
          }), error = _loginSuperAdminSchem.error, value = _loginSuperAdminSchem.value;
          if (!error) {
            _context2.next = 1;
            break;
          }
        ...
        case 1:
          _context2.next = 2;
          return (0, _adminService.superAdminLogin)(value);
        case 2:
  ...
  return function loginSuperAdmin(_x3, _x4) {
...
var listAdmin = exports.listAdmin = /*#__PURE__*/function () {
  ...
  return function listAdmin(_x7, _x8) {
...
var deleteAdminController = exports.deleteAdminController = /*#__PURE__*/function () {
  ...
  return function deleteAdminController(_x1, _x10) {
...
var updateAdminAccessController = exports.updateAdminAccessController = /*#__PURE__*/function () {
  ...
  return function updateAdminAccessController(_x11, _x12) {
...
var getAdminByIdController = exports.getAdminByIdController = /*#__PURE__*/function () {
    ...
    return _regenerator["default"].wrap(function (_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        case 0:
          ...
          return _context8.abrupt("return", res.status(_constant.statusCodes.badRequest).json({
            success: false,
            message: _constant.Message.validationError,
            data: null,
            error: {
        ...
        case 2:
          ...
          return _context8.abrupt("return", res.status(_constant.statusCodes.ok).json({
            success: true,
        ...
        case 3:
          ...
          return _context8.abrupt("return", res.status(_t.statusCode || _constant.statusCodes.internalServerError).json({
            success: false,
            message: _t.message,
            data: null,
            error: {
  ...
  return function getAdminByIdController(_x13, _x14) {
