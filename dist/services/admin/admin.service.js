...
exports.updateAdminAccess = exports.updateAdmin = exports.superAdminLogin = exports.listAdmins = exports.getAdminById = exports.deleteAdmin = exports.adminLogin = exports.addAdmin = void 0;
...
var _superAdmin = _interopRequireDefault(require("../../models/super.admin.js"));
...
var superAdminLogin = exports.superAdminLogin = /*#__PURE__*/function () {
  var _ref4 = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee2(_ref3) {
    var email, password, superAdmin, decryptedPassword, tokenPayload, tokens;
    return _regenerator["default"].wrap(function (_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          email = _ref3.email, password = _ref3.password;
          _context2.next = 1;
          return _superAdmin["default"].findOne({
            email: email
          }).lean();
        case 1:
          superAdmin = _context2.sent;
          if (superAdmin) {
            _context2.next = 2;
            break;
          }
          throw new _exception["default"](_constant.statusCodes.notFound, _constant.Message.notFound, _constant.errorCodes.not_found);
        case 2:
          decryptedPassword = (0, _helperCryto.decrypt)(superAdmin.password);
          if (!(password !== decryptedPassword)) {
            _context2.next = 3;
            break;
          }
        ...
        case 3:
          ...
          return _context2.abrupt("return", _objectSpread({
            superAdmin: _objectSpread({}, superAdmin)
          }, tokens));
        case 4:
        case "end":
  ...
  return function superAdminLogin(_x2) {
...
var listAdmins = exports.listAdmins = /*#__PURE__*/function () {
  var _ref7 = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee4(_ref6) {
    var _ref6$pageNumber, pageNumber, _ref6$pageSize, pageSize, page, limit, skip, totalItems, admins, totalPages, hasNextPage, hasPrevPage;
    return _regenerator["default"].wrap(function (_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _ref6$pageNumber = _ref6.pageNumber, pageNumber = _ref6$pageNumber === void 0 ? 1 : _ref6$pageNumber, _ref6$pageSize = _ref6.pageSize, pageSize = _ref6$pageSize === void 0 ? 10 : _ref6$pageSize;
  ...
  return function listAdmins(_x4) {
...
var updateAdmin = exports.updateAdmin = /*#__PURE__*/function () {
  var _ref9 = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee5(_ref8) {
    ...
    return _regenerator["default"].wrap(function (_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          adminId = _ref8.adminId, updateData = (0, _objectWithoutProperties2["default"])(_ref8, _excluded);
          _context5.next = 1;
        ...
        case 3:
          updatedAdmin = _context5.sent;
          return _context5.abrupt("return", updatedAdmin);
        case 4:
        case "end":
  ...
  return function updateAdmin(_x5) {
...
var updateAdminAccess = exports.updateAdminAccess = /*#__PURE__*/function () {
  var _ref11 = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee7(_ref10) {
    ...
    return _regenerator["default"].wrap(function (_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          adminId = _ref10.adminId, access = _ref10.access;
          _context7.next = 1;
          return _adminModel["default"].findById(adminId).lean();
        case 1:
        ...
        case 3:
          updatedAdmin = _context7.sent;
          return _context7.abrupt("return", updatedAdmin);
        case 4:
        case "end":
  ...
  return function updateAdminAccess(_x7) {
...
var getAdminById = exports.getAdminById = /*#__PURE__*/function () {
    ...
    return _regenerator["default"].wrap(function (_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        ...
        case 1:
          ...
          throw new _exception["default"](_constant.statusCodes.notFound, 'Admin not found', _constant.errorCodes.not_found);
        case 2:
          return _context8.abrupt("return", admin);
        case 3:
        case "end":
  ...
  return function getAdminById(_x8) {
