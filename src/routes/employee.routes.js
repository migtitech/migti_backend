...
employeeRouter.post(
  '/create',
  authenticateToken,
  checkPermission(MODULES.EMPLOYEES, 'create'),
...
employeeRouter.get(
  '/list',
  authenticateToken,
  checkPermission(MODULES.EMPLOYEES, 'read'),
...
employeeRouter.delete(
  '/delete',
  authenticateToken,
  checkPermission(MODULES.EMPLOYEES, 'delete'),
  asyncHandler(deleteEmployeeController)
)
