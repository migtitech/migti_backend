...
companyRouter.post(
  '/create',
  authenticateToken,
  checkPermission(MODULES.COMPANIES, 'create'),
  asyncHandler(createCompanyController)
)
companyRouter.get(
  '/list',
  authenticateToken,
  checkPermission(MODULES.COMPANIES, 'read'),
...
companyRouter.get(
  ...
  authenticateToken,
  checkPermission(MODULES.COMPANIES, 'read'),
  asyncHandler(getCompanyByIdController)
)
companyRouter.put(
  '/update',
  authenticateToken,
  checkPermission(MODULES.COMPANIES, 'update'),
  asyncHandler(updateCompanyController)
)
companyRouter.delete(
  '/delete',
  authenticateToken,
  checkPermission(MODULES.COMPANIES, 'delete'),
