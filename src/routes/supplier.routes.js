...
supplierRouter.post(
  '/create',
  authenticateToken,
  checkPermission(MODULES.SUPPLIERS, 'create'),
  asyncHandler(createSupplierController)
)
supplierRouter.get(
  '/list',
  authenticateToken,
  checkPermission(MODULES.SUPPLIERS, 'read'),
...
supplierRouter.put(
  '/update',
  authenticateToken,
  checkPermission(MODULES.SUPPLIERS, 'update'),
  asyncHandler(updateSupplierController)
)
supplierRouter.delete(
  '/delete',
  authenticateToken,
  checkPermission(MODULES.SUPPLIERS, 'delete'),
