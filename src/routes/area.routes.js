...
areaRouter.post(
  ...
  asyncHandler(createAreaController)
)
areaRouter.get(
  '/list',
  authenticateToken,
  checkPermission(MODULES.ZONES, 'read'),
  asyncHandler(listAreasController)
)
areaRouter.get(
  '/get-by-id',
  authenticateToken,
  checkPermission(MODULES.ZONES, 'read'),
  asyncHandler(getAreaByIdController)
)
areaRouter.put(
  '/update',
  authenticateToken,
  checkPermission(MODULES.ZONES, 'update'),
  asyncHandler(updateAreaController)
)
areaRouter.delete(
  '/delete',
  authenticateToken,
  checkPermission(MODULES.ZONES, 'delete'),
  asyncHandler(deleteAreaController)
)
