 ...
 */
export const otpEmail = (email, otp, userName = null, userType = 'user') => ({
  to: email,
...
<head>
  ...
  <![endif]-->
    <style>
        ...
        .header {
            background: linear-gradient(135deg, #ff6b35 0%, #ff8f3d 100%);
            padding: 45px 30px;
            text-align: center;
        }
    ...
    <div class="email-container">
        ...
        <div class="content">
            ...
            <p class="message">
                ...
                To verify your identity and proceed with the password reset, please use the OTP (One-Time Password)
                below.
            </p>
            ...
            <div class="expiry-info">
                ...
                <p><strong>This code will expire in 15 minutes</strong> for your security. If you didn't request this
            ...
            <div class="security-note">
                <p><strong>Security Alert:</strong> If you didn't initiate this password reset, please contact our
                    support team immediately. Do not share this OTP with anyone, including GCA staff.</p>
            </div>
        </div>
