...
export const registerIndividual = (referralCode) =>
  `${BASE_URL}/register-individual?referralCode=${referralCode}`
export const registerAssociation = (token) =>
  `${BASE_URL}/register-association?token=${token}`
